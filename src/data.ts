...
export const projects: Project[] = [
  ...
  {
    title: 'NeuroSync',
    subtitle: 'SDGP University Group Project — Web Platform',
    description: 'A collaborative university project built as part of the Software Development Group Project (SDGP) module. NeuroSync is a web platform developed with a team, demonstrating full-stack development skills, collaborative workflows, and modern deployment practices.',
    features: [
